...
camera.position.z = objToRender === "dino" ? 100 : 420;
...
const middleLight = new THREE.DirectionalLight(0x9400D3, 1); // (color, intensity)
middleLight.position.set(10, 10, 10) //top-left-ish
middleLight.castShadow = true;
scene.add(middleLight);


const ambientLight = new THREE.AmbientLight(0xffffff, objToRender === "car" ? 1 : 1);
